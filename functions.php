...
***************************************************************************/
	...
	DEFINE("PROJECTTHEME_VERSION", "4.0.8");
	DEFINE("PROJECTTHEME_RELEASE", "8 Jan 2020");
		    ...
		    <ul class="navbar-nav mr-auto">
		        ...
		        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
		          ...
		          <a class="dropdown-item" href="<?php echo projectTheme_post_new_link(); ?>"><?php _e("Post New Project",'ProjectTheme');?></a>
							 ...
							 <a  class="dropdown-item"href="<?php echo get_permalink(get_option('ProjectTheme_my_account_received_bids_id')); ?>"><?php _e("Received Bids",'ProjectTheme');?></a>
...
{	$author_info = get_userdata($uid);
	...
	if(empty($per_hour)) $per_hour = rand(5,55);
		...
		?>
			...
			<div class="card bg-light mb-3 card-of-user " id="user-box-<?php echo $uid ?>"> <div class="card-body text-center">
	...
	?>
	 <div class="user-table-row"><div class=" row">
		<div class="col-xs-12 col-sm-8 col-md-4 col-lg-2 av-usr">
        		<a href="<?php echo ProjectTheme_get_user_profile_link($uid); ?>"><img src="<?php echo ProjectTheme_get_avatar($uid,95, 95) ?>" alt="avatar-user" class="acc_m1 av1z" width="95" height="95" /></a>
        </div>
        ...
        <div class="user-table-user-info col-xs-12 col-sm-4 col-md-8 col-lg-10">
            	...
            	<ul>
                    ...
                    <li class="last"><a href="<?php echo ProjectTheme_get_user_feedback_link($uid); ?>"><?php _e('User Feedback','ProjectTheme'); ?></a></li>
						...
						<div class="col button-hire1"><a href="<?php echo site_url() ?>/?p_action=hire_freelancer&uid=<?php echo $uid ?>" class="btn btn-primary" role="button"><?php printf(__('%s Hire this freelancer','ProjectTheme'), '<i class="fas fa-briefcase"></i>') ?></a></div>
